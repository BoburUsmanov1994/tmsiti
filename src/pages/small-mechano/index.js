...
export default function SmallMechanos() {
    ...
    const handleClickFormat1 = () => {
        setIsActive(2)
    }

    const handleClickFormat2 = () => {
        setIsActive(1)
    }

    const handleClickFormat3 = () => {
        setIsActive(0)
    }
        ...
        <Main>
            ...
            <Section>
                <div className="grid grid-cols-12 gap-x-8 ">
                    {
                        !isEmpty(get(volumes, 'results', [])) && get(volumes, 'results', []).map(volume => <div
                            key={get(volume, 'id')} className={'col-span-3 mb-5'}><Category logo_url={'category_logo'} name={'category_name'} url={'small-mechano/category'}
                            data={volume}/></div>)
                    }
                </div>
                <div className="grid grid-cols-12 gap-x-8 mt-[30px] min-h-fit">
                    ...
                    <div className={'col-span-12 flex gap-x-[10px] mb-[30px]'}>
                        <button onClick={()=> handleClickFormat3()} className={`${ isActive === 0 ? "bg-[#1890FF] text-white" : "bg-transparent text-[#28366D]"} rounded-[5px]`}>
                            <svg width="44" height="44" viewBox="0 0 44 44" fill="none"   xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_475_3020)">
                                    <path d="M7.3335 11H17.4168" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M7.3335 18.3335H17.4168" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M7.3335 25.6665H17.4168" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M7.3335 33H17.4168" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M26.5835 11H36.6668" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M26.5835 18.3335H36.6668" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M26.5835 25.6665H36.6668" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M26.5835 33H36.6668" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                </g>
                                <defs>
                        ...
                        <button onClick={()=> handleClickFormat1()} className={`${ isActive === 2 ? "bg-[#1890FF] text-white" : "bg-transparent text-[#28366D]"} rounded-[5px]`}>
                            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_475_3038)">
                                    ...
                                    <path d="M20.1665 34.8333C20.1665 35.3196 20.3597 35.7859 20.7035 36.1297C21.0473 36.4735 21.5136 36.6667 21.9998 36.6667C22.4861 36.6667 22.9524 36.4735 23.2962 36.1297C23.64 35.7859 23.8332 35.3196 23.8332 34.8333C23.8332 34.3471 23.64 33.8808 23.2962 33.537C22.9524 33.1932 22.4861 33 21.9998 33C21.5136 33 21.0473 33.1932 20.7035 33.537C20.3597 33.8808 20.1665 34.3471 20.1665 34.8333Z" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M33 34.8333C33 35.3196 33.1932 35.7859 33.537 36.1297C33.8808 36.4735 34.3471 36.6667 34.8333 36.6667C35.3196 36.6667 35.7859 36.4735 36.1297 36.1297C36.4735 35.7859 36.6667 35.3196 36.6667 34.8333C36.6667 34.3471 36.4735 33.8808 36.1297 33.537C35.7859 33.1932 35.3196 33 34.8333 33C34.3471 33 33.8808 33.1932 33.537 33.537C33.1932 33.8808 33 34.3471 33 34.8333Z" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"/>
                                </g>
                                <defs>
...

                    {
                        get(items, 'results', []).map(item => <div key={get(item, 'material_csr_code')}
                            ...
                            {isActive === 1 && <Product viewUrl={'small-mechano'} name={'smallmechano_name'} code={'smallmechano_csr_code'} img={'smallmechano_image'} data={item}/>}
                            {isActive === 0 && <Format1 viewUrl={'small-mechano'} name={'smallmechano_name'} code={'smallmechano_csr_code'} img={'smallmechano_image'} data={item}/>}
                            {isActive === 2 && <Format1 viewUrl={'small-mechano'} name={'smallmechano_name'} code={'smallmechano_csr_code'} img={'smallmechano_image'} data={item}/>}
                        </div>)
                    }
