                ...
                <div className="grid grid-cols-12 gap-x-8 mt-[30px] min-h-fit">
...

                    {
                        get(items, 'results', []).map(item => <div key={get(item, 'material_csr_code')}
                            ...
                            <Product template={(isActive == 0 || isActive == 2) ? 'list' : 'card'}  viewUrl={'small-mechano'} name={'smallmechano_name'} code={'smallmechano_csr_code'} img={'smallmechano_image'} data={item}/>
