                ...
                <div className="grid grid-cols-12 gap-x-8 mt-[30px] min-h-fit">
...

                    {
                        get(items, 'results', []).map(item => <div key={get(item, 'material_csr_code')}
                            ...
                            {isActive === 1 && <Product viewUrl={'technos'} name={'techno_name'} code={'techno_csr_code'} img={'techno_image'} data={item}/>}
                            {isActive === 0 && <Format1 viewUrl={'technos'} name={'techno_name'} code={'techno_csr_code'} img={'techno_image'} data={item}/>}
                            {isActive === 2 && <Format1 viewUrl={'technos'} name={'techno_name'} code={'techno_csr_code'} img={'techno_image'} data={item}/>}
                        </div>)
                    }
