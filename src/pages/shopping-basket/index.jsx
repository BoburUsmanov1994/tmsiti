                      ...
                      <div>
                        <div key={index}
                          ...
                          {/* Product description*/}
                            ...
                            <p ref={materialNameRef} className={`text-base ${isEmpty(get(JSON.parse(head(item)), "techno_name")) ? "hidden" : "visible"} font-bold`}>{get(JSON.parse(head(item)), "techno_name")}</p>
