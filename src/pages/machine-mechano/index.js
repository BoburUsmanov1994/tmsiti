                ...
                <div className="grid grid-cols-12 gap-x-8 mt-[30px] min-h-fit">
...

                    {
                        get(items, 'results', []).map(item => <div key={get(item, 'material_csr_code')}
                            ...
                            {isActive === 1 && <Product viewUrl={'machine-mechano'} name={'mmechano_name'} code={'mmechano_csr_code'} img={'mmechano_image'} data={item}/>}
                            {isActive === 0 && <Format1 viewUrl={'machine-mechano'} name={'mmechano_name'} code={'mmechano_csr_code'} img={'mmechano_image'} data={item}/>}
                            {isActive === 2 && <Format1 viewUrl={'machine-mechano'} name={'mmechano_name'} code={'mmechano_csr_code'} img={'mmechano_image'} data={item}/>}
                        </div>)
                    }
