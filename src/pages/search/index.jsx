...

                    {
                        get(data, 'data.results', [])?.length == 0 ?
                            <div className={'col-span-12 mb-5 text-[#515D89] text-xl'}>Sizning so’rovingizga mos natija
                                ...
                                {isActive === 1 && <Product viewUrl={get(split(get(material, 'resource_url'), '/'), '[1]')} img={'resource_image'} code={'resource_code'} name={'resource_name'} data={material}/>}
                                {isActive === 0 && <Format1 viewUrl={get(split(get(material, 'resource_url'), '/'), '[1]')} img={'resource_image'} code={'resource_code'} name={'resource_name'} data={material}/>}
                                {isActive === 2 && <Format1 viewUrl={get(split(get(material, 'resource_url'), '/'), '[1]')} img={'resource_image'} code={'resource_code'} name={'resource_name'} data={material}/>}
                                </div>)
                    }
