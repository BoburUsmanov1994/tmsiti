                ...
                <Section className={'!bg-white'}>
                    <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-7">
                            <div className="flex">
                                <div className={'inline-flex mr-8'}>
                                    <Image className={'mr-2'} width={24} height={24} src={'/icons/code.svg'}
                                           alt={'code'}/>
                                    <span className={'font-medium'}>#{get(material, 'data.work_csr_code')}</span>
                                </div>
                                <div className={'inline-flex mr-8'}>
                                    <Image className={'mr-2'} width={24} height={24} src={'/icons/eye.svg'}
                                           alt={'code'}/>
                                    <span
                                        className={'font-medium'}>{get(material, 'data.work_views_count', 0)}</span>
                                </div>
                            ...
                            <h2 className={'my-3 text-xl font-semibold'}>{get(material, 'data.work_name')}</h2>
                            <p className={'text-[#4B5055] text-sm'}>{get(material, 'data.work_description', '-')}</p>
                        </div>
                    </div>
                </Section>
                <Section>
