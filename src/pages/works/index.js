                ...
                <div className="grid grid-cols-12 gap-x-8 mt-[30px] min-h-fit">
...

                    {
                        get(items, 'results', []).map(item => <div key={get(item, 'work_csr_code')}
                            ...
                            {isActive === 1 && <Product name={'work_name'} code={'work_csr_code'} data={item} img={'work_image'} viewUrl={'works'}/>}
                            {isActive === 0 && <Format1 name={'work_name'} code={'work_csr_code'} data={item} img={'work_image'} viewUrl={'works'}/>}
                            {isActive === 2 && <Format1 name={'work_name'} code={'work_csr_code'} data={item} img={'work_image'} viewUrl={'works'}/>}
                        </div>)
                    }
