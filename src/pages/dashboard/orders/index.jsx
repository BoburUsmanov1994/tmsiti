                    ...
                    : get(row, "order_status") === "accepted" ?
                        <div>
                            ...
                            <div className={"flex flex-col items-center gap-y-2  rounded-[6px]"}>
                                ...
                                <button className={"flex bg-yellow-600 text-white py-2 px-8 rounded-[6px] hover:bg-yellow-700 active:bg-yellow-500 items-center gap-x-2"} onClick={() => handleSendOrderStatus(get(row, "id"), "on_way")}>
