            ...
            <div>
              ...
              <div className={"text-xs text-black my-[6px]"}>
                <p>
                  ...
                  {isNull(get(item, "company_phone_main"))
                    ? "Ma'lumot kiritilmagan"
                    : get(item, "company_phone_main")}
                </p>
              </div>
              ...
              <div className={"text-xs text-black my-[6px]"}>
                <p>
                  ...
                  {isNull(get(item, "company_address"))
                    ? "Ma'lumot kiritilmagan"
                    : get(item, "company_address")}
                </p>
              </div>
              <Link
                href={`/dashboard/about/${get(item, "company_stir")}`}
                className={
