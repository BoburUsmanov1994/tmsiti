        ...
        >
          ...
          <div className={"col-span-6 "}>
            ...
            <div className={"flex items-center rounded-[5px]"}>
              <input
                placeholder={"Uskuna/qurilma narxi"}
                type={"number"}
          ...
          <div className={"col-span-6 mt-[15px]"}>
            ...
            <input
              placeholder={"Uskuna/qurilma miqdori"}
              type={"number"}
          ...
          <div className={"col-span-6"}>
            <h4 className={"text-[#28366D] text-base mt-[15px]"}>
          ...
          <div className={"col-span-6 mt-[15px]"}>
            ...
            <label
              for="dropzone-file"
              className={`shadow-2xl py-[20px] px-[30px] my-[10px] bg-${get(
                techno,
                "techno_image"
              )} rounded-[5px] cursor-pointer  flex flex-col justify-center items-center  w-[320px] h-[224px] `}
            >
              <Image
          ...
          <div className={"col-span-6 mt-[15px]"}>
            ...
            <div>
              ...
              <input
                placeholder={"Uskuna/qurilma sertifikati blank raqami"}
            ...
            <div className={"mt-[15px]"}>
              ...
              <input
                placeholder={"Uskuna/qurilma sertifikati reestr raqami"}
