...
const Template = ({
    ...
    return (
        <div className={'col-span-12 flex gap-x-[10px] mb-[30px]'}>
            <button onClick={() => handleClickFormat(0)}
                ...
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_475_3020)">
                        ...
                        <path d="M7.3335 25.6665H17.4168" stroke="currentColor" strokeWidth="2.75"
                              strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M7.3335 33H17.4168" stroke="currentColor" strokeWidth="2.75" strokeLinecap="round"
                              strokeLinejoin="round"/>
                        <path d="M26.5835 11H36.6668" stroke="currentColor" strokeWidth="2.75" strokeLinecap="round"
                              strokeLinejoin="round"/>
                        <path d="M26.5835 18.3335H36.6668" stroke="currentColor" strokeWidth="2.75"
                              strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M26.5835 25.6665H36.6668" stroke="currentColor" strokeWidth="2.75"
                              strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M26.5835 33H36.6668" stroke="currentColor" strokeWidth="2.75" strokeLinecap="round"
                              strokeLinejoin="round"/>
                    </g>
                    <defs>
            ...
            <button onClick={() => handleClickFormat(1)}
                    className={clsx("bg-transparent text-[#28366D] rounded-[5px]",{"!bg-[#1890FF] !text-white": active == 1})}>
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
